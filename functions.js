...
function edit(id) {
    ...
    right_x.appendChild(createElem('input', '', [['type', 'button'], ['value', 'X'], ['onclick', 'deleteEvent("' + data + '")']]));
...
function addCell(id) {
    ...
    var description = createElem('textarea', '', [['id', 'description'], ['name', 'description'], ['value', ''], ['rows', '2'], ['cols', '30'], ['onkeyup', 'autogrow(this)'], ['onchange', 'autogrow(this)']]);
